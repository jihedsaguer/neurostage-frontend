...
import { useFetchMyStagesAsProQuery } from '@/redux/features/stages/stagesApi';
...
const ProStagesPage = () => {
  ...
  const { data: stages = [], isLoading, isError, refetch } = useFetchMyStagesAsProQuery();
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        {/* Header */}
        <div>
          <h1 className="text-2xl font-semibold text-slate-900">Mes Stages Supervisés</h1>
          <p className="text-slate-500 text-sm mt-1">Stages où vous êtes encadrant professionnel</p>
        </div>
